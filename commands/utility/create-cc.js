...
module.exports = {
  ...
  userpermissions: ["MANAGE_GUILD"],
    ...
    if(!args[0]) return message.channel.send(`<:exe_cross:1304703179535028254> | specify the command \`create <cmd> <response>\``)
    ...
    try {
      ...
      if(!data) {
        if(!args[1]) return message.channel.send(`<:exe_cross:1304703179535028254> | specify the response \`create <cmd> <response>\``)
